...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'authn_method_add': IDL.Func([IdentityNumber, AuthnMethodData], [IDL.Variant({ 'Ok': IDL.Null, 'Err': AuthnMethodAddError })], []),
        'authn_method_confirm': IDL.Func([IdentityNumber, IDL.Text], [
            IDL.Variant({
                'Ok': IDL.Null,
                'Err': AuthnMethodConfirmationError,
            }),
        ], []),
        'authn_method_metadata_replace': IDL.Func([IdentityNumber, PublicKey, MetadataMapV2], [
            IDL.Variant({
                'Ok': IDL.Null,
                'Err': AuthnMethodMetadataReplaceError,
            }),
        ], []),
        'authn_method_register': IDL.Func([IdentityNumber, AuthnMethodData], [
            IDL.Variant({
                'Ok': AuthnMethodConfirmationCode,
                'Err': AuthnMethodRegisterError,
            }),
        ], []),
        'authn_method_registration_mode_enter': IDL.Func([IdentityNumber], [
            IDL.Variant({
                'Ok': IDL.Record({ 'expiration': Timestamp }),
                'Err': IDL.Null,
            }),
        ], []),
        'authn_method_registration_mode_exit': IDL.Func([IdentityNumber], [IDL.Variant({ 'Ok': IDL.Null, 'Err': IDL.Null })], []),
        'authn_method_remove': IDL.Func([IdentityNumber, PublicKey], [IDL.Variant({ 'Ok': IDL.Null, 'Err': IDL.Null })], []),
        'authn_method_replace': IDL.Func([IdentityNumber, PublicKey, AuthnMethodData], [IDL.Variant({ 'Ok': IDL.Null, 'Err': AuthnMethodReplaceError })], []),
        'authn_method_security_settings_replace': IDL.Func([IdentityNumber, PublicKey, AuthnMethodSecuritySettings], [
            IDL.Variant({
                'Ok': IDL.Null,
                'Err': AuthnMethodSecuritySettingsReplaceError,
            }),
        ], []),
        'captcha_create': IDL.Func([], [IDL.Variant({ 'Ok': Challenge, 'Err': IDL.Null })], []),
        ...
        'get_id_alias': IDL.Func([GetIdAliasRequest], [IDL.Variant({ 'Ok': IdAliasCredentials, 'Err': GetIdAliasError })], ['query']),
        'get_principal': IDL.Func([UserNumber, FrontendHostname], [IDL.Principal], ['query']),
        'http_request': IDL.Func([HttpRequest], [HttpResponse], ['query']),
        'http_request_update': IDL.Func([HttpRequest], [HttpResponse], []),
        'identity_authn_info': IDL.Func([IdentityNumber], [IDL.Variant({ 'Ok': IdentityAuthnInfo, 'Err': IDL.Null })], ['query']),
        'identity_info': IDL.Func([IdentityNumber], [IDL.Variant({ 'Ok': IdentityInfo, 'Err': IdentityInfoError })], []),
        'identity_metadata_replace': IDL.Func([IdentityNumber, MetadataMapV2], [
            IDL.Variant({
                'Ok': IDL.Null,
                'Err': IdentityMetadataReplaceError,
            }),
        ], []),
        'identity_register': IDL.Func([AuthnMethodData, CaptchaResult, IDL.Opt(IDL.Principal)], [IDL.Variant({ 'Ok': IdentityNumber, 'Err': IdentityRegisterError })], []),
        'init_salt': IDL.Func([], [], []),
        ...
        'prepare_id_alias': IDL.Func([PrepareIdAliasRequest], [IDL.Variant({ 'Ok': PreparedIdAlias, 'Err': PrepareIdAliasError })], []),
